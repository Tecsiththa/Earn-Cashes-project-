                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="ad-actions">
                                <button class="btn-edit" onclick='editAd(<?php echo json_encode($ad); ?>)'>Edit</button>
                                ...
                                <button class="btn-delete" onclick="deleteAd(<?php echo $ad['id']; ?>, '<?php echo htmlspecialchars($ad['title']); ?>')">Delete</button>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
