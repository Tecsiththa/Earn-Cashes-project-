                ...
                <div class="card available-ads">
                    ...
                    <div class="ads-list">
                        <?php if ($available_ads->num_rows > 0): ?>
                            ...
                            <div class="ad-item">
                                <img src="<?php echo htmlspecialchars($ad['image_url'] ?? 'https://via.placeholder.com/80x60'); ?>" alt="Ad Thumbnail">
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <h4>EarnCash</h4>
                    <p>Earn money by watching advertisements</p>
                </div>
                <div class="footer-section">
                    <h4>Quick Links</h4>
                    <ul>
            ...
            <div class="footer-bottom">
                <p>&copy; 2024 EarnCash. All rights reserved.</p>
            </div>
        </div>
    </footer>
